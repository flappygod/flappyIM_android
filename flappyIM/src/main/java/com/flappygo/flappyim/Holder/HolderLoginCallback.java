...
public class HolderLoginCallback {
    ...
    //登录的回调
    private ConcurrentHashMap<String, FlappyIMCallback> loginCallbacks = new ConcurrentHashMap<>();
    ...
    //登录成功的回调
    public void addLoginCallBack(String uuid, FlappyIMCallback callBack) {
        //保存当前的回调
        loginCallbacks.put(uuid, callBack);
    }

    //返回回调
    public FlappyIMCallback getLoginCallBack(String uuid) {
        //获取之前加入的回调
